...
> Basado en *Clean Architecture: A Craftsman's Guide to Software Structure and Design* de Robert C. Martin (2017)
...
- [Capítulo 20: Reglas comerciales (Reglas de negocio)](#)
- [Capítulo 21: Arquitectura que grita](#)
...
- [Capítulo 27: Servicios: ¿Arquitectura de servicios grande y pequeña?](#)
...
- [Capítulo 32: Los marcos (frameworks) son detalles](#)
- [Capítulo 33: Estudio de caso: Ventas de vídeos](#)
- [Capítulo 34: El capítulo perdido](#)

---

> ⚠️ Esta sección está en construcción. Cada capítulo será desarrollado próximamente con ejemplos prácticos y diagramas.
